...
import { Package, ShoppingBag, PlusCircle, Users } from 'lucide-react'
...
function Dashboard() {
  ...
  const business = useMemo(() => {
    return {
      averageOrder: orders.length === 0 ? 0 : Math.round(stats.revenue / orders.length),
    }
  }, [orders, stats])
  ...
  return (
    <>
      <SummaryCards stats={stats} business={business} />

      <ActiveOrders stats={stats} recentOrders={recentOrders} />
